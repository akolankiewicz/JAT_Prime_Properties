...
public class Vendedor extends Cliente {
    ...
    public void adicionarImovel() {
        ...
        imoveis.add(imovel);
        Imovel.getListaImoveis().add(imovel);
        System.out.println("");
    }
    ...
    public void editarImovel(Imovel imovel) {
        while (true) {
            try {
                ...
                System.out.print(
                        "Mobiliado (atual: " + (imovel.getMobiliado() ? "Sim" : "Não") + ") (digite true ou false): ");
                ...
                if (imovel instanceof Apartamento) {
                    ...
                    System.out
                            .print("Sacada (atual: " + (apt.isSacada() ? "Sim" : "Não") + ") (digite true ou false): ");
                    ...
                    System.out
                            .print("Piscina (atual: " + (casa.getPiscina() ? "Sim" : "Não")
                    ...
                    System.out
                            .print("Garagem (atual: " + (casa.getGaragem() ? "Sim" : "Não")
                                    + ") (digite true ou false): ");
                    ...
                    System.out
                            .print("Quintal (atual: " + (casa.getQuintal() ? "Sim" : "Não")
                                    + ") (digite true ou false): ");

...
public class Vendedor extends Cliente {
    ...
    public void editarImovel(Imovel imovel) {
        ...
        if (imovel instanceof Apartamento) {
            ...
            System.out.print("Área de Manobra (atual: " + (pavilhao.isAreaManobra() ? "Sim" : "Não") + ") (digite true ou false): ");
            ...
            System.out.print("Espaço para Estacionamento (atual: " + (comercial.isEspacoEstacionamento() ? "Sim" : "Não") + ") (digite true ou false): ");
